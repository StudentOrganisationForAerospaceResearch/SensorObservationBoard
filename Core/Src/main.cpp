...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, Clk_pin_Pin|Data_pin_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Clk_pin_Pin Data_pin_Pin */
  GPIO_InitStruct.Pin = Clk_pin_Pin|Data_pin_Pin;
